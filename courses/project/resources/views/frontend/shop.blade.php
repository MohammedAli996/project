                ...
                <div class="col-lg-6 text-lg-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-lg-end mb-0 px-0 bg-light">
                            <li class="breadcrumb-item"><a class="text-dark" href="{( route(('frontend.index')) }}">Home</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{( route(('frontend.detail')) }}">Kui Ye Chen’s
                                        AirPods</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{( route(('frontend.detail')) }}">Air Jordan 12 gym
                                        red</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{( route(('frontend.detail')) }}">Cyan cotton
                                        t-shirt</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{( route(('frontend.detail')) }}">Nike air max 95</a>
                                </h6>
                                <p class="small text-muted">$300</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{( route(('frontend.detail')) }}">Black DSLR lense</a>
                                </h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
